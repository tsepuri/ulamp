...
var ModelNumberCharacteristic = function(model) {
    bleno.Characteristic.call(this, {
        uuid: '2A24',
        properties: ['read'],
        descriptors: [
...
var SerialNumberCharacteristic = function(serial) {
    bleno.Characteristic.call(this, {
        uuid: '2A25',
        properties: ['read'],
        descriptors: [
...
function DeviceInfoService(manufacturer, model, serial) {
    bleno.PrimaryService.call(this, {
        ...
        characteristics: [
            ...
            new ModelNumberCharacteristic(model),
            new SerialNumberCharacteristic(serial),
        ]
    });
}
